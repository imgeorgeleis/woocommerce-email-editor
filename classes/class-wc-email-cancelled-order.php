...
if ( ! class_exists( 'WC_Email_Editor_Cancelled_Order' ) ) :
 ...
 * @extends     WC_Email
 */
class WC_Email_Editor_Cancelled_Order extends WC_Email {
	...
	public function get_content_html() {
		return wc_get_template_html( $this->template_html, array(
			...
			'email_contents'=> $this->format_string(
				apply_filters(
					'the_content',
					$this->get_option( 'email_contents', __( 'The order #{order_number} from {billing_first_name} {billing_last_name} has been cancelled. The order was as follows:', 'woocommerce' ) )
				)
			)
		) );
	}
