...
if ( ! class_exists( 'WC_Email_Editor_New_Order' ) ) :
 ...
 * @extends     WC_Email
 */
class WC_Email_Editor_New_Order extends WC_Email {
	...
	public function get_content_html() {
		return wc_get_template_html( $this->template_html, array(
			...
			'email_contents'=> $this->format_string(
				apply_filters(
					'the_content',
					$this->get_option( 'email_contents', __( 'You have received an order from {billing_first_name} {billing_last_name}. The order is as follows:', 'woocommerce' ) )
				)
			)
		) );
	}
