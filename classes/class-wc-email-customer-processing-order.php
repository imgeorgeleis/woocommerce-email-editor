...
if ( ! class_exists( 'WC_Email_Editor_Customer_Processing_Order' ) ) :
 ...
 * @extends     WC_Email
 */
class WC_Email_Editor_Customer_Processing_Order extends WC_Email {
	...
	function get_content_html() {
		return wc_get_template_html( $this->template_html, array(
			...
			'email_contents'=> $this->format_string(
				apply_filters(
					'the_content',
					$this->get_option( 'email_contents', __( 'Your order has been received and is now being processed. Your order details are shown below for your reference: {cart}', 'woocommerce' ) )
				)
			)
		) );
	}
